...
export const PRIORITY_GOALS: Record<string, PriorityGoal[]> = {
  ...
  default: [
    ...
    },
    {
      ...
      nextMilestone: "Block 3 focus sessions on your calendar",
      milestoneDate: "",
      backgroundColor: "#EAE6ED",
    },
    {
      ...
      nextMilestone: "Add your first project and 3 tasks",
      milestoneDate: "",
      backgroundColor: "#EAE6ED",
    },
  ],
...
export const WORKSPACES: Record<string, Workspace[]> = {
  ...
  default: [
    ...
    { id: "w2", name: "Health & Body", icon: "heart", bgColor: "#FD8B71", type: "personal", taskCount: 0 },
    { id: "w3", name: "Work", icon: "briefcase", bgColor: "#C3B5EE", type: "professional", taskCount: 0 },
    { id: "w4", name: "Learning", icon: "gradcap", bgColor: "#E4E279", type: "professional", taskCount: 0 },
  ],
};
